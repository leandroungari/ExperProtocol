 ...
 */
@WebServlet(name = "salvarPacote", urlPatterns = {"/salvarPacote"})
public class salvarPacote extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String json = servlet.nextLine();
        servlet.close();
        
        System.out.println(json);
        
        ExperimentFactory.extract(json);
