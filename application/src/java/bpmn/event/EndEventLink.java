...
public class EndEventLink extends EndEvent{
    ...
    public EndEventLink(String id, int x, int y, String description, ArrayList<Element> elements, ArrayList<ConnectionObject> transitions, ArrayList<String> vinculos) {
