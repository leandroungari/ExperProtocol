 ...
 */
@XStreamAlias("IntermediateEventCatchNonInterruptingEscalation")
public class IntermediateEventCatchNonInterruptingEscalation extends IntermediateEvent {
    ...
    public IntermediateEventCatchNonInterruptingEscalation(String id, float x, float y, String description, ArrayList<Element> elements, ArrayList<ConnectionObject> transitions, ArrayList<String> vinculos) {
        ...
        setName("intermediate-event-catch-non-floaterrupting-escalation");
    }
