...
public class StartEventSignal extends StartEvent{
    ...
    public StartEventSignal(String id, int x, int y, String description, ArrayList<Element> elements, ArrayList<ConnectionObject> transitions, ArrayList<String> vinculos) {
