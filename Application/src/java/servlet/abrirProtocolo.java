 ...
 */
@WebServlet(name = "abrirProtocolo", urlPatterns = {"/abrirProtocolo"})
public class abrirProtocolo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        BPMNFactory.fromXML(xml);
        
        String jsonObjeto = BPMNFactory.export();
        //response.setContentType("application/json");
        PrintStream out = new PrintStream(response.getOutputStream(), true, "UTF-8");
        
        out.println(jsonObjeto);
        out.close();
    }
